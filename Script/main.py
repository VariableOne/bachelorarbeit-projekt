...
val_logs   = generate_logs_with_sessions(num_sessions=250, anomaly_probability=0.05, include_labels=True)
test_logs  = generate_logs_with_sessions(num_sessions=250, anomaly_probability=0.05, include_labels=True)
